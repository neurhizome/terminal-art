...
| [005](docs/_posts/2026-02-21-session-005-wolf-interval.md) | **Wolf Interval** | The circle of fifths draws itself via stigmergy; the wolf gap appears with no rule placing it |
| [006](docs/_posts/2026-02-21-session-006-mathematical-forms.md) | **Mathematical Forms** | Mandelbrot, Recamán, Lissajous in ASCII; mathematical objects have feelings that survive translation |
...
The **working cycle** is documented in `CYCLE.md` — phases, interludes, and a sleep cycle that compresses discoveries into parables, music prompts, image prompts, and quest entries. The quest board is one of its outputs.
